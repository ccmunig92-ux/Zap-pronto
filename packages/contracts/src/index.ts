...
export const AssignmentPolicyModeSchema=Type.Union([Type.Literal("OBSERVE"),Type.Literal("ENFORCE_NEW_ASSIGNMENTS")]);
export type AssignmentPolicyMode=Static<typeof AssignmentPolicyModeSchema>;
export const UnitAssignmentPolicyParamsSchema=Type.Object({unitId:Type.String({format:"uuid"})},{additionalProperties:false});
export const AssignmentPolicyReadinessSchema=Type.Object({operationalMembers:Type.Integer({minimum:0}),effectiveSchedules:Type.Integer({minimum:0}),missingSchedules:Type.Integer({minimum:0}),timezoneConfigured:Type.Boolean(),ready:Type.Boolean()},{additionalProperties:false});
export const UnitAssignmentPolicyBaseSchema=Type.Object({unitId:Type.String({format:"uuid"}),mode:AssignmentPolicyModeSchema,version:Type.Integer({minimum:1}),updatedAt:Type.String({format:"date-time"})},{additionalProperties:false});
export const UnitAssignmentPolicySchema=Type.Composite([UnitAssignmentPolicyBaseSchema,Type.Object({readiness:AssignmentPolicyReadinessSchema},{additionalProperties:false})],{additionalProperties:false});
export type UnitAssignmentPolicy=Static<typeof UnitAssignmentPolicySchema>;
export const SetUnitAssignmentPolicyRequestSchema=Type.Object({expectedVersion:Type.Integer({minimum:1}),mode:AssignmentPolicyModeSchema},{additionalProperties:false});
export type SetUnitAssignmentPolicyRequest=Static<typeof SetUnitAssignmentPolicyRequestSchema>;
export const SetUnitAssignmentPolicyResponseSchema=Type.Composite([UnitAssignmentPolicyBaseSchema,Type.Object({replayed:Type.Boolean()},{additionalProperties:false})],{additionalProperties:false});
export type SetUnitAssignmentPolicyResponse=Static<typeof SetUnitAssignmentPolicyResponseSchema>;
