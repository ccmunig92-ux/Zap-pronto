const badRequest = new Set(["INVALID_IDEMPOTENCY_KEY", "INVALID_EMAIL", "INVALID_DISPLAY_NAME",
  ...
  "INVALID_INVITATION_TOKEN", "VERIFIED_EMAIL_REQUIRED", "INVALID_MEMBERSHIP_VERSION",
  "INVALID_MEMBERSHIP_OPERATION", "INVALID_MEMBERSHIP_LIFECYCLE_REQUEST"]);
const conflict = new Set(["IDEMPOTENCY_CONFLICT", "USER_ALREADY_EXISTS", "INVITATION_ALREADY_PENDING",
  ...
  "MEMBERSHIP_CONFLICT", "MEMBERSHIP_IDEMPOTENCY_CONFLICT", "MEMBERSHIP_HAS_ACTIVE_WORK", "LAST_TENANT_ADMIN"]);
const notFound = new Set(["OIDC_PROVIDER_NOT_FOUND", "UNIT_NOT_FOUND", "USER_NOT_FOUND", "INVITATION_NOT_FOUND", "MEMBERSHIP_NOT_FOUND"]);
