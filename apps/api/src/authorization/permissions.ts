...
export const rolePermissions = {
  ...
  UNIT_MANAGER: ["unit.members.manage", "handoff.read", "handoff.history.read", "handoff.claim", "handoff.resolve", "handoff.reopen", "handoff.requeue", "handoff.transfer", "handoff.takeover", "conversation.read", "conversation.supervise", "message.send", "message.cancel", "quote.read", "quote.review", "quote.publish", "medical_order.read", "medical_order.review"],
  SUPERVISOR: ["handoff.read", "handoff.history.read", "handoff.claim", "handoff.resolve", "handoff.reopen", "handoff.requeue", "handoff.transfer", "handoff.takeover", "conversation.read", "conversation.supervise", "message.send", "message.cancel", "quote.read", "quote.review", "medical_order.read", "medical_order.review"],
