...
alertas. O gestor reconhece a versão 1 com clique duplo, o navegador emite exatamente um `POST` e, após
reload, o reconhecimento continua visível. Em seguida, o gestor assume e devolve o atendimento à fila;
a versão 3 exige um novo reconhecimento, também persistente após reload e com exatamente um novo `POST`.
O controlador exige dois acknowledgements, dois comandos idempotentes e dois audits
