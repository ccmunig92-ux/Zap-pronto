...
('90000000-0000-4000-8000-000000000013','90000000-0000-4000-8000-000000000001','supervisor.local@example.test','Supervisor Local','ACTIVE')
...
('90000000-0000-4000-8000-000000000001','90000000-0000-4000-8000-000000000013','90000000-0000-4000-8000-000000000002','SUPERVISOR')
...
DELETE FROM audit_events WHERE tenant_id='90000000-0000-4000-8000-000000000001'
  AND action='UNIT_ASSIGNMENT_POLICY_CHANGED';
DELETE FROM unit_assignment_policy_commands WHERE tenant_id='90000000-0000-4000-8000-000000000001';
UPDATE unit_assignment_policies SET mode='OBSERVE',version=1,updated_by_user_id=NULL,updated_at=clock_timestamp()
WHERE tenant_id='90000000-0000-4000-8000-000000000001';
...
WHERE tenant_id='90000000-0000-4000-8000-000000000001'
  ...
  AND user_id IN('90000000-0000-4000-8000-000000000010','90000000-0000-4000-8000-000000000011','90000000-0000-4000-8000-000000000012','90000000-0000-4000-8000-000000000013');
...
('90000000-0000-4000-8000-000000000001','90000000-0000-4000-8000-000000000002','90000000-0000-4000-8000-000000000013','AVAILABLE',100,NULL,NULL,1,clock_timestamp())
...
DELETE FROM user_oidc_identities WHERE tenant_id='90000000-0000-4000-8000-000000000001'
  AND user_id='90000000-0000-4000-8000-000000000013' AND oidc_provider_id='90000000-0000-4000-8000-000000000020';
...
('90000000-0000-4000-8000-000000000001','90000000-0000-4000-8000-000000000013','90000000-0000-4000-8000-000000000020','91000000-0000-4000-8000-000000000004','ACTIVE')
